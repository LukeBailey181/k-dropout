...
def evaluate_subnets_in_pooled_dropout_net(path_to_model, num_subnets, test_set, run_name, wandb_config):
...
def evaluate_subnets_in_dropout_net(path_to_model, num_subnets, test_set, run_name, wandb_config):
...
def evaluate_ensemble_of_subnets(path_to_model, num_subnets, test_set, train_set, epochs, lr, seed, device):
    # seed experiment
