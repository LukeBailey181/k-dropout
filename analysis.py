...
def evaluate_subnets_in_pooled_dropout_net(path_to_model, num_subnets, test_set):
...
def evaluate_subnets_in_dropout_net(path_to_model, num_subnets, test_set):
...
if __name__ == "__main__": 
    ...
    if args.experiment_type == "pool_subnets":
        ...
        raise NotImplementedError("Standard dropout subnet experiment not implemented yet")
